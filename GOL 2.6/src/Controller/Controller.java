...
public class Controller implements Initializable {
    ...
    @FXML private ChoiceBox choicebox;
        ObservableList<String> options = FXCollections.observableArrayList("Game Of Life","HIOA","Tie Fighter","Star","Death Star","Mega Man","Nothing");
   ...
   */  
    ...
    * @param newMove 
    */
   void loadVisualization(boolean [][] newMove){
   ...
   if(choicebox.getValue().equals("Mega Man")){  
            currentMove = new boolean[hei][wid];
            numberOfGenerations = 0;
            String generationText = Long.toString(numberOfGenerations);
            generationCounter.setText(generationText);       
            PatternImport.generateMegaMan(currentMove);
            background();
            GridAndCells.CellActivation(gc, canvas, hei, wid, currentMove, colorPicker2);
            GridAndCells.PaintGrid(gc, canvas, hei, wid);    
   }
